...
const Chat = () => {
  ...
  return (
    <div className="nav-item absolute right-5 md:right-52 top-16 bg-white 
      ...
      <div className="mt-5 ">
        {chatData?.map((item, index) => (
          <div key={index} className="flex items-center gap-5 border-b-1 
        ...
        type="button" className={`text-white rounded-md 
          p-3 w-full hover:drop-shadow-xl hover:bg-[${currentColor}]`}>
           see all messages
          </button>
        </div>
      </div>
