...
import { FiBarChart, FiBarChart2, FiUsers, FiMail } from 'react-icons/fi';
import { FcSalesPerformance } from 'react-icons/fc';
import { BsBox, BsBoxSeam, BsCurrencyDollar, BsShield, BsChatLeft } from 'react-icons/bs';
import { BiMessageAlt, BiGroup } from 'react-icons/bi';
...
import { MdOutlineFeedback, MdOutlineSupervisorAccount, MdShowChart } from 'react-icons/md';
...
export const TotalIncomeData = [
  ...
  { month: 'Dec', 'sales': 3800 },
];

export const ExpensesChart = [
  { month: 'Jan', 'expense': 7500 },
  { month: 'Feb', 'expense': 6000 },
  { month: 'Mar', 'expense': 5800 },
  { month: 'Apr', 'expense': 7000 },
  { month: 'May', 'expense': 7500 },
  { month: 'June', 'expense': 5500 },
  { month: 'July', 'expense': 6900 },
  { month: 'Aug', 'expense': 8000 },
  { month: 'Sep', 'expense': 9500 },
  { month: 'Oct', 'expense': 7000 },
  { month: 'Nov', 'expense': 5600 },
  { month: 'Dec', 'expense': 9800 },
];


export const OrdersSalesChart = [
  { month: 'Jan', 'orders': 5500, ordersDelivered: "5300" },
  { month: 'Feb', 'orders': 6000, ordersDelivered: "5800" },
  { month: 'Mar', 'orders': 5800, ordersDelivered: "5000" },
  { month: 'Apr', 'orders': 7000, ordersDelivered: "6100" },
  { month: 'May', 'orders': 4500, ordersDelivered: "4200" },
  { month: 'June', 'orders': 4500, ordersDelivered: "3300" },
  { month: 'July', 'orders': 5900, ordersDelivered: "4500" },
  { month: 'Aug', 'orders': 8000, ordersDelivered: "7000" },
  { month: 'Sep', 'orders': 9500, ordersDelivered: "9000" },
  { month: 'Oct', 'orders': 7000, ordersDelivered: "6400" },
  { month: 'Nov', 'orders': 6600, ordersDelivered: "5200" },
  { month: 'Dec', 'orders': 9800, ordersDelivered: "9200" },
];
...
export const links = [
...

  {
    ...
    links: [
      {
        name: 'Customers',
        icon: <FiUsers /> || <AiOutlineUsergroupAdd />,
      },
      {
        name: 'Products',
        icon: <BsBox />,
      ...
      {
        name: 'Employees',
        icon: <BiGroup ClassName='dark:text-white'/>,
      },
      // {
      //   name: 'Reports',
      //     icon: <TbReportAnalytics /> || <TbNotes />,
      // }
    ],
  },
  {
    ...
    links: [
      {
        name: 'Message',
        icon: <BiMessageAlt  /> || <AiOutlineMessage />,
      },
      // {
      //   name: 'Mail',
      //   icon: <CiMail /> || <FiMail />,
      ...
      // {
      //   name: 'Feedback',
      //   icon: <VscFeedback /> || <MdOutlineFeedback />,
      // }
    ],
  }
];
